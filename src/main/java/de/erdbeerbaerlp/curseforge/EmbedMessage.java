...
public class EmbedMessage {
    ...
    private static final int// Got from CurseForge
                ...
                .addField(new WebhookEmbed.EmbedField(false, "Build",
                        ("""
                                **Release Type**: `%s`
                                 ...
                                 **Category**: `%s`
                                 **GameVersion**: `%s`""")
                                .formatted(file.releaseType().name(), file.displayName(),
                                        proj.categorySection().name(), getGameVersions(proj))))
                ...
                .addField(new WebhookEmbed.EmbedField(false, "Build",
                        ("""
                                **Release Type**: `%s`
                                 ...
                                 **Category**: `%s`
                                 **GameVersion**: `%s`
                                 **Download Link**: [Download](%s)""")
                                .formatted(file.releaseType().name(), file.displayName(),
                                        proj.categorySection().name(),
                                        getGameVersions(proj), file.downloadURL())))
                .addField(new WebhookEmbed.EmbedField(false, "Changelog:",
                        ("""
                                ```%s
                                %s
